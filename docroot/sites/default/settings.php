...
# }
$config_directories = array(
  #CONFIG_ACTIVE_DIRECTORY => '/var/www/wcet/current/active',
  CONFIG_STAGING_DIRECTORY => '/var/www/wcet/staging',
  CONFIG_SYNC_DIRECTORY => '/var/www/wcet/staging',
);

// $config_directories['sync'] = '/var/www/wcet/current/staging';

$settings['trusted_host_patterns'] = array(
  'wcet.wiche.edu'
);

$settings['hash_salt'] = 'bUmc1PV9VzwAXbaOBp7QNugOCWzsUrRgyy7Zl7D2dJm-J8Wb5n_VVRtSKKwFWOUrDKH7zepC2A';

# Support running behind a proxy server.
#$settings['reverse_proxy'] = TRUE;
# IP addresses of the proxy servers must be explicitly defined here
